(function () {
  window.carousel1 = dCarousel(
    document.querySelector(".d-carousel--example-1"),
    {
      delta: function () {
        return 16;
      },
...
(function () {
  ...
  var count = 0;
  window.carousel2 = dCarousel(example2, {
    paddingLeft: true,
    delta: function () {
      return 16;
    },
...
(function () {
  ...
  var getFontSize = function () {
    return parseFloat(
      window.getComputedStyle(root).fontSize.replace("px", ""),
      10
    );
  };
  var fontSize = getFontSize();

  window.carousel3 = dCarousel(
    document.querySelector(".d-carousel--example-3"),
    {
      delta: function () {
